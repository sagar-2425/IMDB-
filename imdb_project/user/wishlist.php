...
$stmt = $conn->prepare("SELECT movies.* FROM movies JOIN wishlist ON movies.id = wishlist.movie_id WHERE wishlist.user_id = ?");
            ...
            <div class="movie-card">
                ...
                <div class="content-container">
                    ...
                    <div class="buttons-container">
                        ...
                        <a href="remove_wishlist.php?id=<?= $movie['id'] ?>" class="remove-button">Remove</a>
                    </div>
                </div>
            </div>
        <?php endforeach; ?>
